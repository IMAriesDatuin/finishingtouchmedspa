...
// TEST
gulp.task('test', gulp.series(clearcache, version, mode, backup, clear, html, injectwebfontloader, lintjs, vendorsjs, frameworkjs, corejs, mainjs, combinejs, css, injectscripts, move, appicons, meta, zipassets, a11ycheck, optimizeassets, clean, sync));


// BUILD
gulp.task('build', gulp.series(version, clear, revconfig, html, injectfullstory, injectga, injectgtm, injectwebfontloader, lintjs, vendorsjs, frameworkjs, corejs, mainjs, combinejs, css, tempcss, criticalcss, move, zipassets, appicons, meta, a11ycheck, fingerprintassets, injectscripts, optimizeassets, robots, sitemap, clean, minify, sw, preview, completed));
...
// PARTIAL TESTING
gulp.task('dev', gulp.series(version, clear, revconfig, html, injectwebfontloader, lintjs, vendorsjs, frameworkjs, corejs, mainjs, combinejs, css, tempcss, criticalcss, move, appicons, meta, a11ycheck, fingerprintassets, injectscripts, optimizeassets, minify, clean, completed));
